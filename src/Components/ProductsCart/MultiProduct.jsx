                ...
                {chips_count !== 0 ?
                    <div class="relative grid grid-cols-6 gap-4">
                        ...
                        <div class="absolute right-0">
                            <button className="w-8 h-8 bg-gray-300 bg-gray-300" onClick={() => handleDecrementChips()}>-</button>
                        </div>
                    </div>
                ...
                {milk_count !== 0 ?
                    <>
                        ...
                        <div class="relative grid grid-cols-6 gap-4">
                            ...
                            <div class="absolute right-0">
                                <button className="w-8 h-8 bg-gray-300 bg-gray-300" onClick={() => handleDecrementMilk()}>-</button>
                            </div>
                        </div>
                    </>
                    : null
                ...
                {milo_count !== 0 ?
                    <>
                        ...
                        <div class="relative grid grid-cols-6 gap-4">
                            ...
                            <div class="absolute right-0">
                                <button className="w-8 h-8 bg-gray-300 bg-gray-300" onClick={() => handleDecrementMilo()}>-</button>
                            </div>
                        </div>
                    </>
                    : null
                ...
                {cereal_count !== 0 ?
                    <>
                        ...
                        <div class="relative grid grid-cols-6 gap-4">
                            ...
                            <div class="absolute right-0">
                                <button className="w-8 h-8 bg-gray-300 bg-gray-300" onClick={() => handleDecrementCereal()}>-</button>
                            </div>
                        </div>
                    </>
                    : null
